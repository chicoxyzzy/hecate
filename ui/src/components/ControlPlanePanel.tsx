...
type ControlPlaneView = "tenants" | "api-keys" | "activity";

export function ControlPlanePanel(props: ControlPlanePanelProps) {
  const [view, setView] = useState<ControlPlaneView>("tenants");
    ...
    <Panel eyebrow="Control Plane" title="Tenants and keys">
      {props.controlPlane ? (
        <div className="mt-4 grid gap-4">
          ...
          {view === "tenants" ? (
            <section className="grid gap-4 lg:grid-cols-[1.2fr_minmax(0,0.8fr)]">
              <article className="rounded-2xl bg-slate-50/90 p-4">
                <h3 className="text-lg font-semibold text-slate-900">Saved tenants</h3>
              ...
              <article className="rounded-2xl bg-slate-50/90 p-4">
                <h3 className="text-lg font-semibold text-slate-900">Create or update tenant</h3>
                <div className="mt-3 grid gap-3">
          ...
          {view === "api-keys" ? (
            <section className="grid gap-4 lg:grid-cols-[1.2fr_minmax(0,0.8fr)]">
              <article className="rounded-2xl bg-slate-50/90 p-4">
                <h3 className="text-lg font-semibold text-slate-900">Saved API keys</h3>
                <div className="mt-3 grid gap-3">
              ...
              <div className="grid gap-4">
                <article className="rounded-2xl bg-slate-50/90 p-4">
                  <h3 className="text-lg font-semibold text-slate-900">Create or update API key</h3>
                  <div className="mt-3 grid gap-3">
                ...
                <article className="rounded-2xl bg-slate-50/90 p-4">
                  <h3 className="text-lg font-semibold text-slate-900">Rotate key</h3>
                  <div className="mt-3 grid gap-3">
