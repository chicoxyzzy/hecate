...
func TestBudgetEndpointsAllowTenantKeyInSingleUserAdminMode(t *testing.T) {
	t.Parallel()
	...
	tenantClient := newAPITestClient(t, handler).withBearerToken("tenant-secret")
	response := mustRequestJSON[BudgetStatusResponse](tenantClient, http.MethodGet, "/admin/budget", "")
