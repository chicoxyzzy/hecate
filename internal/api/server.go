...
func NewServer(logger *slog.Logger, handler *Handler) http.Handler {
	...
	mux.HandleFunc("POST /admin/control-plane/providers/enabled", handler.HandleControlPlaneSetProviderEnabled)
	mux.HandleFunc("POST /admin/control-plane/providers/rotate-secret", handler.HandleControlPlaneRotateProviderSecret)
	mux.HandleFunc("POST /admin/control-plane/providers/delete", handler.HandleControlPlaneDeleteProvider)
