...
func NewServer(logger *slog.Logger, handler *Handler) http.Handler {
	...
	mux.HandleFunc("GET /v1/traces", handler.HandleTenantTraces)
	mux.HandleFunc("GET /v1/requests", handler.HandleTenantRequestLedger)
	mux.HandleFunc("GET /v1/runtime/stats", handler.HandleTenantRuntimeStats)
