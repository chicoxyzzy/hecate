...
var builtInProviders = []BuiltInProvider{
	{
		...
		ExampleModels: []string{"gpt-5.4-mini", "gpt-5.4", "gpt-5.4-nano"},
	...
	},
	{
		...
		ExampleModels: []string{"claude-sonnet-4-6", "claude-opus-4-7", "claude-haiku-4-5-20251001"},
	...
	},
	{
		...
		ExampleModels: []string{"gemini-2.5-flash", "gemini-2.5-pro", "gemini-2.5-flash-lite", "gemini-3-pro-preview"},
